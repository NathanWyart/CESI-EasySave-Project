        ...
        {
            {
                "English", new Dictionary<string, string>
                {
                    ...
                    { "SoftwareMenu", "Business Softwares Management" },
                    { "AddSoftware", "Add a Business Software" },
                    { "RemoveSoftware", "Delete a Business Software" },
                    { "ShowSoftwares", "List Business Softwares" },
                    { "SoftwareList", "Business Softwares List : " },
                    { "EmptyList", "The list is empty." },
                    { "SoftwareToAdd", "Enter the software name (ex: notepad++.exe) : " },
                    { "Software", "The software" },
                    { "HasBeenAdded", "has been added." },
                    { "HasBeenRemoved", "has been removed." },
                    { "SoftwareDelete", "Enter the software number to delete : " },
                    ...
                    { "ChangeEncryptedExtension", "Change encrypted extensions" },
                    { "CurrentEncryptedExtensions", "Encrypted Extensions" },
                    { "AddExtensionToEncrypt", "Add extensions to encrypt" },
                    { "ExtensionToAdd", "Enter the extensions to add (ex. .txt;.docx) : " },
                    { "ConfirmChanges", "Confirm changes from" },
                    { "To", "to" },
                    { "ConfirmReset", "Confirm reset ? (Y/N) : " }
            ...
            },
            {
                "French", new Dictionary<string, string>
                {
                    ...
                    { "SoftwareMenu", "Gestion des logiciels métier" },
                    { "AddSoftware", "Ajouter un logiciel métier" },
                    { "RemoveSoftware", "Supprimer un logiciel métier" },
                    { "ShowSoftwares", "Lister les logiciels métier" },
                    { "SoftwareList", "Liste des logiciels métier : " },
                    { "EmptyList", "La liste est vide." },
                    { "SoftwareToAdd", "Entrez le nom du logiciel (ex: notepad++.exe) : " },
                    { "Software", "Le logiciel" },
                    { "HasBeenAdded", "a été ajouté." },
                    { "HasBeenRemoved", "a été supprimé." },
                    { "SoftwareDelete", "Entrez le numéro du logiciel à supprimer : " },
                    ...
                    { "Reset", "Réinitialiser les extensions" },
                    ...
                    { "ChangeEncryptedExtension", "Changer les extensions à chiffrer" },
                    { "CurrentEncryptedExtensions", "Extensions chiffrées" },
                    { "AddExtensionToEncrypt", "Ajouter une extension à chiffrer" },
                    { "ExtensionToAdd", "Entrer l'extension à ajouter (ex. .txt;.docx) : " },
                    { "ConfirmChanges", "Confirmer les changements de" },
                    { "To", "à" },
                    { "ConfirmReset", "Confirmer la réinitialisation ? (Y/N) : " }
                }
            }
        };
